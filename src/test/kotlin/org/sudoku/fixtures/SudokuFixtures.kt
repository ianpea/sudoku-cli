...
object SudokuFixtures {
    ...
    fun rowViolatedBoard(): Board {
        val values = listOf(
            5, 5, 0, 6, 7, 8, 9, 1, 2, // <- violated cell A2
            6, 7, 2, 1, 9, 5, 3, 4, 8,
            1, 9, 8, 3, 4, 2, 5, 6, 7,
            8, 5, 9, 7, 6, 1, 4, 2, 3,
            4, 2, 6, 8, 5, 3, 7, 9, 1,
        ...
        board.cells[0].type = CellType.FILLABLE
        board.cells[1].type = CellType.FILLABLE
        board.cells[2].type = CellType.FILLABLE

        return board
    }

    fun colViolatedBoard(): Board {
        val values = listOf(
            5, 3, 4, 6, 7, 8, 9, 1, 2,
            5, 7, 2, 1, 9, 0, 3, 4, 8, // <- violated cell B1
            1, 9, 8, 3, 4, 2, 5, 6, 7,
            8, 5, 9, 7, 6, 1, 4, 2, 3,
            4, 2, 6, 8, 5, 3, 7, 9, 1,
            7, 1, 3, 9, 2, 4, 8, 5, 6,
    ...
    fun subgridViolatedBoard(): Board {
        val values = listOf(
            5, 3, 4, 6, 7, 8, 9, 1, 2,
            6, 7, 2, 1, 9, 5, 3, 4, 8,
            1, 9, 5, 3, 4, 2, 0, 6, 7, // <- violated cell C3
            8, 5, 0, 7, 6, 1, 4, 2, 3,
            4, 2, 6, 8, 5, 3, 7, 9, 1,
            7, 1, 3, 9, 2, 4, 8, 5, 6,
            9, 6, 1, 5, 3, 7, 2, 8, 4,
